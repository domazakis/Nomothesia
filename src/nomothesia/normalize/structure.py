...
# Το εισαγωγικό μπροστά δεν γίνεται δεκτό, όσο κι αν μοιάζει με επικεφαλίδα.
# Ο ελληνικός τρόπος τροποποίησης είναι «Το άρθρο 8 αντικαθίσταται ως εξής:
# "Άρθρο 8 …"», οπότε κάθε τροποποιητικός νόμος περιέχει τις επικεφαλίδες του
# νόμου που τροποποιεί. Δεχόμενοι τα εισαγωγικά, ο ν. 5113/2024 θα αποκτούσε
# τα άρθρα του π.δ. 237/1986 ως δικά του.
ARTHRO = re.compile(
    r"^\s*(?:[ΆΑ]ρθρο[νΝ]?|[ΆΑ]ΡΘΡΟ[Ν]?)\s+(\d+)\s*([Α-Ωα-ω])?\s*[.:]?\s*$",
    re.MULTILINE,
)
